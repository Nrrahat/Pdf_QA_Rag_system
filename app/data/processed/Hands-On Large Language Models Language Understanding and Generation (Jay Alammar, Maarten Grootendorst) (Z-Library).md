...
**==> picture [341 x 325] intentionally omitted <==**
...
**==> picture [223 x 76] intentionally omitted <==**
...
**==> picture [225 x 111] intentionally omitted <==**
...
**==> picture [297 x 123] intentionally omitted <==**
...
**==> picture [289 x 131] intentionally omitted <==**
...
**==> picture [293 x 166] intentionally omitted <==**
...
**==> picture [317 x 225] intentionally omitted <==**
...
**==> picture [339 x 106] intentionally omitted <==**
...
**==> picture [243 x 75] intentionally omitted <==**
...
**==> picture [347 x 249] intentionally omitted <==**
...
```
EnglishandCAPITALIZATION<unk><unk>show_tokensFalseNoneelif==>
=else:twotabs:""Threetabs:""12.0*50=600</s>
```
...
**==> picture [249 x 223] intentionally omitted <==**
...
**==> picture [192 x 130] intentionally omitted <==**
...
**==> picture [153 x 127] intentionally omitted <==**
...
**==> picture [320 x 51] intentionally omitted <==**
...
||**id**<br>**Title**<br>**artist**<br>4181<br>Kiss<br>Prince & The Revolution<br>12749<br>Wanna Be Startin’ Somethin’<br>Michael Jackson<br>1506<br>The Way You Make Me Feel<br>Michael Jackson<br>3396<br>Holiday<br>Madonna<br>500<br>Don’t Stop ‘Til You Get Enough Michael Jackson|
|---|---|
...
||**id**<br>**Title**<br>**artist**<br>413<br>If I Ruled the World (Imagine That) (w\/ Lauryn Hill)<br>Nas<br>196<br>I’ll Be Missing You<br>Puf Daddy & The Family<br>330<br>Hate It or Love It (w\/ 50 Cent)<br>The Game<br>211<br>Hypnotize<br>The Notorious B.I.G.<br>5788<br>Drop It Like It’s Hot (w\/ Pharrell)<br>Snoop Dogg|
|---|---|
...
**==> picture [289 x 249] intentionally omitted <==**
...
**==> picture [300 x 239] intentionally omitted <==**
...
**==> picture [269 x 188] intentionally omitted <==**
...
**==> picture [342 x 173] intentionally omitted <==**
...
**==> picture [312 x 212] intentionally omitted <==**
...
**==> picture [345 x 105] intentionally omitted <==**
...
**==> picture [345 x 136] intentionally omitted <==**
...
**==> picture [206 x 220] intentionally omitted <==**
...
**==> picture [263 x 248] intentionally omitted <==**
...
importnumpyasnp
fromtqdmimporttqdm
fromtransformers.pipelines.pt_utilsimportKeyDataset
# Run inference
y_pred= []
foroutputintqdm(pipe(KeyDataset(data["test"], "text")),
total=len(data["test"])):
...
**==> picture [307 x 169] intentionally omitted <==**
...
**==> picture [255 x 187] intentionally omitted <==**
...
**==> picture [299 x 179] intentionally omitted <==**
...
predictions= [
chatgpt_generation(prompt, doc) fordocintqdm(data["test"]["text"])
]
```
...
**==> picture [217 x 85] intentionally omitted <==**
...
**==> picture [308 x 108] intentionally omitted <==**
...
**==> picture [289 x 168] intentionally omitted <==**
...
df["title"] =titles
df["cluster"] = [str(c) forcinclusters]
...
**==> picture [328 x 164] intentionally omitted <==**
...
**==> picture [259 x 138] intentionally omitted <==**
...
**==> picture [277 x 151] intentionally omitted <==**
...
**==> picture [296 x 125] intentionally omitted <==**
...
|||
|---|---|
||**Topic Count Name**<br>**Representation**|
||-1<br>14520<br>-1_the_of_and_to<br>[the, of, and, to, in, we, that, language, for...<br>0<br>2290<br>0_speech_asr_recognition_end<br>[speech, asr, recognition, end, acoustic, spea...<br>1<br>1403<br>1_medical_clinical_biomedical_patient<br>[medical, clinical, biomedical, patient, healt...<br>2<br>1156<br>2_sentiment_aspect_analysis_reviews<br>[sentiment, aspect, analysis, reviews, opinion...<br>3<br>986<br>3_translation_nmt_machine_neural<br>[translation, nmt, machine, neural, bleu, engl...<br>...<br>...<br>...<br>...<br>150<br>54<br>150_coherence_discourse_paragraph_text<br>[coherence, discourse, paragraph, text, cohesi...<br>151<br>54<br>151_prompt_prompts_optimization_prompting<br>[prompt, prompts, optimization, prompting, llm...<br>152<br>53<br>152_sentence_sts_embeddings_similarity<br>[sentence, sts, embeddings, similarity, embedd...<br>153<br>53<br>153_counseling_mental_health_therapy<br>[counseling, mental, health, therapy, psychoth...<br>154<br>50<br>154_backdoor_attacks_attack_triggers<br>[backdoor, attacks, attack, triggers, poisoned...|
|||
...
**==> picture [347 x 235] intentionally omitted <==**
...
```
deftopic_differences(model, original_topics, nr_topics=5):
"""Show the differences in topic representations between two models """
df=pd.DataFrame(columns=["Topic", "Original", "Updated"])
fortopicinrange(nr_topics):
```
...
```
frombertopic.representationimportMaximalMarginalRelevance
```
...
||**Topic Original**<br>**Updated**<br>0<br>speech | asr | recognition | end | acoustic<br>speech | asr | error | model | training<br>1<br>medical | clinical | biomedical | patient | he...<br>clinical | biomedical | patient | healthcare |...<br>2<br>sentiment | aspect | analysis | reviews | opinion<br>sentiment | analysis | reviews | absa | polarity<br>3<br>translation | nmt | machine | neural | bleu<br>translation | nmt | bleu | parallel | multilin...<br>4<br>summarization | summaries | summary | abstract...<br>summarization | document | extractive | rouge ...|
|---|---|
...
```
fromtransformersimportpipeline
frombertopic.representationimportTextGeneration
```
...
||**Topic Original**<br>**Updated**<br>0<br>speech | asr | recognition | end | acoustic<br>Leveraging External Data for Improving Low-Res...<br>1<br>medical | clinical | biomedical | patient | he...<br>Improved Representation Learning for Biomedica...<br>2<br>sentiment | aspect | analysis | reviews | opinion<br>Advancements in Aspect-Based Sentiment Analys...<br>3<br>translation | nmt | machine | neural | bleu<br>Neural Machine Translation Enhancements<br>4<br>summarization | summaries | summary | abstract...<br>Document Summarization Techniques|
|---|---|
...
**==> picture [261 x 141] intentionally omitted <==**
...
**==> picture [321 x 242] intentionally omitted <==**
...
**==> picture [217 x 247] intentionally omitted <==**
...
**==> picture [342 x 130] intentionally omitted <==**
...
**==> picture [337 x 111] intentionally omitted <==**
...
**==> picture [331 x 90] intentionally omitted <==**
...
**==> picture [343 x 135] intentionally omitted <==**
...
**==> picture [265 x 110] intentionally omitted <==**
...
**==> picture [318 x 82] intentionally omitted <==**
...
```
fromlangchain.memoryimportConversationBufferWindowMemory
```
...
**==> picture [320 x 122] intentionally omitted <==**
...
|---|---|---|---|---|
|Conversation<br>Bufer|**•** <br>**•**|Easiest implementation<br> Ensures no information loss within context|**•**|Slower generation speed as more tokens are<br>needed|
...
|Conversation<br>Bufer|**•**|chat history is large<br> No information loss over the last_k_|**•**|No compression of the last_k_interactions|
|||interactions|||
...
**==> picture [347 x 58] intentionally omitted <==**
...
**==> picture [287 x 164] intentionally omitted <==**
...
**==> picture [279 x 135] intentionally omitted <==**
...
**==> picture [247 x 162] intentionally omitted <==**
...
```
foridx, resultinenumerate(results.results):
...
**==> picture [181 x 113] intentionally omitted <==**
...
**==> picture [331 x 159] intentionally omitted <==**
...
**==> picture [315 x 102] intentionally omitted <==**
...
**==> picture [341 x 160] intentionally omitted <==**
...
**==> picture [276 x 180] intentionally omitted <==**
...
**==> picture [265 x 101] intentionally omitted <==**
...
**==> picture [260 x 139] intentionally omitted <==**
...
**==> picture [292 x 130] intentionally omitted <==**
...
**==> picture [222 x 172] intentionally omitted <==**
...
**==> picture [344 x 173] intentionally omitted <==**
...
**==> picture [283 x 110] intentionally omitted <==**
...
**==> picture [146 x 153] intentionally omitted <==**
...
**==> picture [146 x 104] intentionally omitted <==**
...
**==> picture [266 x 61] intentionally omitted <==**
...
**==> picture [178 x 212] intentionally omitted <==**
...
Whenever you are done training and evaluating your model, it is important to _restart_ the notebook. This will clear your VRAM up for the next training examples throughout this chapter. By restart‐ ing the notebook, we can be sure that all VRAM is cleared. 
...
**==> picture [338 x 109] intentionally omitted <==**
...
fromsentence_transformersimportInputExample
fromsentence_transformers.datasetsimportNoDuplicatesDataLoader
...
"label": [mapping[label] forlabelindataset["label"]]
    }
)
```
...
```
fromsentence_transformers.cross_encoderimportCrossEncoder
```
...
**==> picture [173 x 222] intentionally omitted <==**
...
fromtqdmimporttqdm
fromdatasetsimportDataset, load_dataset
fromsentence_transformers.datasetsimportDenoisingAutoEncoderDataset
```
...
**==> picture [295 x 164] intentionally omitted <==**
...
**==> picture [313 x 140] intentionally omitted <==**
...
**==> picture [326 x 197] intentionally omitted <==**
...
**==> picture [240 x 191] intentionally omitted <==**
...
**==> picture [293 x 191] intentionally omitted <==**
...
forindex, (name, param) inenumerate(model.named_parameters()):
ifindex<165:
param.requires_grad=False
# Trainer which executes the training process
trainer=Trainer(
...
**==> picture [284 x 186] intentionally omitted <==**
...
**==> picture [314 x 90] intentionally omitted <==**
...
**==> picture [252 x 220] intentionally omitted <==**
...
```
fromsetfitimportsample_dataset
```
...
```
fromtransformersimportAutoTokenizer, AutoModelForMaskedLM
```
...
**==> picture [300 x 129] intentionally omitted <==**
...
**==> picture [267 x 198] intentionally omitted <==**
...
id2label= {index: labelforlabel, indexinlabel2id.items()}
label2id
```
...
updated_labels= []
forindex, labelinenumerate(labels):
...
ifword_idx!=previous_word_idx:
previous_word_idx=word_idx
updated_label=-100ifword_idxis Noneelselabel[word_idx]
...
**==> picture [242 x 53] intentionally omitted <==**
...
**==> picture [319 x 79] intentionally omitted <==**
...
**==> picture [256 x 133] intentionally omitted <==**
...
**==> picture [222 x 275] intentionally omitted <==**
...
**==> picture [192 x 38] intentionally omitted <==**
...
**==> picture [271 x 63] intentionally omitted <==**
...
**==> picture [342 x 72] intentionally omitted <==**
...
**==> picture [330 x 128] intentionally omitted <==**
...
**==> picture [287 x 218] intentionally omitted <==**
